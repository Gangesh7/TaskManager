  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-900">
      <div className="relative bg-gray-800 text-white p-8 w-96 rounded-xl shadow-2xl border border-teal-500/50">
        ...
        <h2 className="text-3xl font-extrabold text-teal-400 text-center mb-6 animate-pulse">Login</h2>
        ...
        <form onSubmit={handleSubmit} className="relative z-10">
          ...
          <div className="mb-4">
            ...
            <p className="text-center text-gray-400 mt-3">
              ...
              <Link to="/register" className="text-teal-400 hover:text-teal-500 font-semibold ml-1 transition-all">
                Register
              </Link>
            </p>
          </div>
